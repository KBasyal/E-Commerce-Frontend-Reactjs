...
const AdminCategoryEdit = () => {
    ...
    const submitEvent = async (data: any) => {
        try {
            ...
            await axiosInstance.put('/category/'+params.id, mappedData, {
                headers: {
    ...
    //     return root.category.categoryDetail
                                    ...
                                    <form onSubmit={handleSubmit(submitEvent)} className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 ">
                                            ...
                                            <div className="block w-[25%">
                                                <img src={import.meta.env.VITE_IMAGE_URL +"/uploads/categorys/"+detail?.image} crossOrigin="anonymous"></img>
