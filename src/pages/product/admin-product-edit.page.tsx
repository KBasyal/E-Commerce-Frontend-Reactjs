...
const AdminProductEdit = () => {
    ...
    const submitEvent = async (data: any) => {
        try {
            ...
            await axiosInstance.put('/product/'+params.id, mappedData, {
                headers: {
    ...
    const getProductById =async() =>{
        try{
            const response :any = await axiosInstance.get("/product/"+params.id,{
                headers:{
                    "Authorization": "Bearer " + localStorage.getItem('accessToken')
    ...
    //     return root.product.productDetail
                                    ...
                                    <form onSubmit={handleSubmit(submitEvent)} className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 ">
                                            ...
                                            <div className="block w-[25%">
                                                <img src={import.meta.env.VITE_IMAGE_URL +"/uploads/products/"+detail?.image} crossOrigin="anonymous"></img>
